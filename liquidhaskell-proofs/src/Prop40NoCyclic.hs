...
-- prop_40_no_cyclic: (cyclegg_take Cyclegg_Z cyclegg_xs) = Cyclegg_Nil
module Prop40NoCyclic where
...
{-@ prop_40_no_cyclic :: cyclegg_xs: Cyclegg_List a -> { (cyclegg_take Cyclegg_Z cyclegg_xs) = Cyclegg_Nil } @-}
prop_40_no_cyclic :: Cyclegg_List a -> Proof
prop_40_no_cyclic cyclegg_xs =
