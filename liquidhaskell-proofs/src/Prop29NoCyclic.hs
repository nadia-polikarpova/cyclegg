...
{-@ prop_29_no_cyclic :: cyclegg_x: Cyclegg_Nat -> cyclegg_xs: (Cyclegg_List Cyclegg_Nat) -> { (cyclegg_elem cyclegg_x (cyclegg_ins1 cyclegg_x cyclegg_xs)) = Cyclegg_True } / [listSize (Cyclegg_Cons cyclegg_x cyclegg_xs)]@-}
prop_29_no_cyclic :: Cyclegg_Nat -> (Cyclegg_List Cyclegg_Nat) -> Proof
prop_29_no_cyclic = undefined
