...
{-@ prop_87_no_cyclic :: cyclegg_f: (cyclegg_b -> cyclegg_c)
                      -> cyclegg_g: (cyclegg_a -> cyclegg_b)
                      -> cyclegg_e: (Cyclegg_Expr cyclegg_a)
                      -> { cyclegg_mapE (cyclegg_comp cyclegg_f cyclegg_g) (cyclegg_e)
                       = cyclegg_mapE cyclegg_f (cyclegg_mapE cyclegg_g cyclegg_e) } @-}
