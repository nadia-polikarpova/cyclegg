...
{-@ prop_52_no_cyclic :: cyclegg_n: Cyclegg_Nat -> cyclegg_xs: (Cyclegg_List Cyclegg_Nat) -> { (cyclegg_count cyclegg_n cyclegg_xs) = (cyclegg_count cyclegg_n (cyclegg_rev cyclegg_xs)) } / [listSize cyclegg_xs] @-}
prop_52_no_cyclic :: Cyclegg_Nat -> (Cyclegg_List Cyclegg_Nat) -> Proof
prop_52_no_cyclic cyclegg_n cyclegg_xs = undefined
  -- case cyclegg_n of
