...
-- prop_88_no_cyclic: (cyclegg_argsE (cyclegg_mapE cyclegg_f cyclegg_e)) = (cyclegg_map ($ cyclegg_mapE cyclegg_f) (cyclegg_argsE cyclegg_e))
module Prop88NoCyclic where
...
{-@ prop_88_no_cyclic :: cyclegg_f: (cyclegg_a -> cyclegg_b) -> cyclegg_e: (Cyclegg_Expr cyclegg_a) -> { (cyclegg_argsE (cyclegg_mapE cyclegg_f cyclegg_e)) = (cyclegg_map (cyclegg_mapE cyclegg_f) (cyclegg_argsE cyclegg_e)) } @-}
prop_88_no_cyclic :: (cyclegg_a -> cyclegg_b) -> (Cyclegg_Expr cyclegg_a) -> Proof
prop_88_no_cyclic cyclegg_f cyclegg_e =
  case cyclegg_e of
    (Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81) ->
      case cyclegg_e_80 of
        (Cyclegg_App cyclegg_e_80_150 cyclegg_e_80_151) ->
          -- prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81) =>
          -- (cyclegg_mapE ?f (Cyclegg_MkExpr ?t ?n)) =>
          -- (cyclegg_argsE (Cyclegg_MkExpr ?t ?n)) =>
          -- prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81):cyclegg_e_80=(Cyclegg_App cyclegg_e_80_150 cyclegg_e_80_151) =>
          -- (cyclegg_mapT ?f (Cyclegg_App ?e1 ?e2)) =>
          -- (cyclegg_argsT (Cyclegg_App ?e1 ?e2)) =>
          -- <= apply-cyclegg_mapE
          prop_88_no_cyclic cyclegg_f cyclegg_e_80_150
          -- ih-equality-cyclegg_f=cyclegg_f,cyclegg_e=cyclegg_e_80_150 =>
          -- <= (cyclegg_map ?f (Cyclegg_Cons ?x ?xs))
          -- <= (cyclegg_argsT (Cyclegg_App ?e1 ?e2))
          -- <= prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81):cyclegg_e_80=(Cyclegg_App cyclegg_e_80_150 cyclegg_e_80_151)
          -- <= (cyclegg_argsE (Cyclegg_MkExpr ?t ?n))
          -- <= prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81)
        (Cyclegg_Cst cyclegg_e_80_150) ->
          -- prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81) =>
          -- (cyclegg_mapE ?f (Cyclegg_MkExpr ?t ?n)) =>
          -- (cyclegg_argsE (Cyclegg_MkExpr ?t ?n)) =>
          -- prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81):cyclegg_e_80=(Cyclegg_Cst cyclegg_e_80_150) =>
          ...
          -- <= prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81)
          ()
        (Cyclegg_Var cyclegg_e_80_150) ->
          -- prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81) =>
          -- (cyclegg_mapE ?f (Cyclegg_MkExpr ?t ?n)) =>
          -- (cyclegg_argsE (Cyclegg_MkExpr ?t ?n)) =>
          -- prop_88_no_cyclic:cyclegg_e=(Cyclegg_MkExpr cyclegg_e_80 cyclegg_e_81):cyclegg_e_80=(Cyclegg_Var cyclegg_e_80_150) =>
