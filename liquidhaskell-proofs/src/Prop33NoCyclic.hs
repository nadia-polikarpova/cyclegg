...
-- prop_33_no_cyclic: (cyclegg_eq (cyclegg_min cyclegg_a cyclegg_b) cyclegg_a) = (cyclegg_leq cyclegg_a cyclegg_b)
module Prop33NoCyclic where
...
{-@ prop_33_no_cyclic :: cyclegg_a: Cyclegg_Nat -> cyclegg_b: Cyclegg_Nat -> { (cyclegg_eq (cyclegg_min cyclegg_a cyclegg_b) cyclegg_a) = (cyclegg_leq cyclegg_a cyclegg_b) } @-}
prop_33_no_cyclic :: Cyclegg_Nat -> Cyclegg_Nat -> Proof
prop_33_no_cyclic cyclegg_a cyclegg_b =
  case cyclegg_a of
    (Cyclegg_S cyclegg_a_50) ->
      case cyclegg_b of
        (Cyclegg_S cyclegg_b_100) ->
          -- prop_33_no_cyclic:cyclegg_a=(Cyclegg_S cyclegg_a_50) =>
          -- prop_33_no_cyclic:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=(Cyclegg_S cyclegg_b_100) =>
          -- (cyclegg_min (Cyclegg_S ?x) (Cyclegg_S ?y)) =>
          -- prop_33_no_cyclic:cyclegg_a=(Cyclegg_S cyclegg_a_50) =>
          -- (cyclegg_eq (Cyclegg_S ?x) (Cyclegg_S ?y)) =>
          prop_33_no_cyclic cyclegg_a_50 cyclegg_b_100
          -- ih-equality-cyclegg_a=cyclegg_a_50,cyclegg_b=cyclegg_b_100 =>
          -- <= (cyclegg_leq (Cyclegg_S ?x) (Cyclegg_S ?y))
          -- <= prop_33_no_cyclic:cyclegg_a=(Cyclegg_S cyclegg_a_50)
          -- <= prop_33_no_cyclic:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=(Cyclegg_S cyclegg_b_100)
        (Cyclegg_Z ) ->
          -- prop_33_no_cyclic:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=Cyclegg_Z =>
          ...
          ()
    (Cyclegg_Z ) ->
      -- prop_33_no_cyclic:cyclegg_a=Cyclegg_Z =>
