...
(assert (forall ((acc Nat)) (= (plusAccum zero zero acc) acc)))
(assert (forall ((n Nat) (acc Nat)) (= (plusAccum zero (succ n) acc) (plusAccum zero n (succ acc)))))
(assert (forall ((m Nat) (n Nat) (acc Nat)) (= (plusAccum (succ m) n acc) (plusAccum m n (succ acc)))))
(assert (not
(forall ((a Nat) (b Nat) (c Nat)) (= (plus a (plus b c)) (plusAccum a b c))) ; plus accum
))
(check-sat)
